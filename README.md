...
- GUI
  ...
  * Karta 2: Mapa z zaznaczonymi bunkrami w twojej obecnej lokalizacji (możliwość wybrania promienia odległości)
      + po zaznaczeniu bunkra pojawia się okienko z informacjami na jego temat (tag z okresem budowy, informację o tym czy odwiedzony, możliwość skopiowania współrzędnych)
  * Karta 3: Osiągnięcia (możliwość wyświetlenia twoich odznak, oraz tych których jeszcze nie masz; coś a’la steam)
...
- powiadomienia o otrzymaniu odznaki i przy dodaniu znajomych
